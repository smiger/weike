<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"./views/home/mobile/task\index.phtml";i:1578038128;s:71:"D:\BaiduYunDownload\weike2\public\views\home\mobile\common\footer.phtml";i:1541935408;}*/ ?>
<!DOCTYPE HTML>
<html>
	<head>
        ...
        <div class="paging">
            ...
            <span class="paging-num-total">
					<select name="page" class="paging-selct">
                        <?php $__FOR_START_203398914__=1;$__FOR_END_203398914__=$pageCount+1;for($i=$__FOR_START_203398914__;$i < $__FOR_END_203398914__;$i+=1){ ?>
