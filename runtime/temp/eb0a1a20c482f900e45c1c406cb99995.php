<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"./views/home/mobile/index\index.phtml";i:1578379376;s:71:"D:\BaiduYunDownload\weike2\public\views\home\mobile\common\footer.phtml";i:1578387613;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
	<head>
...
<!--                    <?php if(is_array($withdraws) || $withdraws instanceof \think\Collection || $withdraws instanceof \think\Paginator): $i = 0; $__LIST__ = $withdraws;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$withdraw): $mod = ($i % 2 );++$i;?>-->
<!--                        <div class="swiper-slide swiper-slide-duplicate">-->
...
<!--    </div>-->
    <div class="new-site-tit">
        今天完成所有任务可获得：<span id="expect_gold"><?php echo $today_credit2; ?></span> 积分
    </div>
        ...
        <div class="paging">
            ...
            <span class="paging-num-total">
					<select name="page" class="paging-selct">
                        <?php $__FOR_START_1700538549__=1;$__FOR_END_1700538549__=$pageCount+1;for($i=$__FOR_START_1700538549__;$i < $__FOR_END_1700538549__;$i+=1){ ?>
