<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"./views/home/mobile/invite\index.phtml";i:1578038126;s:71:"D:\BaiduYunDownload\weike2\public\views\home\mobile\common\footer.phtml";i:1541935408;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
        ...
        <div class="main inivteFriend">
            ...
            <div class="add-box">
                <div class="add-cont">
                    ...
                    <div class="sns_box">
                        <textarea id="sharetext" class="text_box" style="color:#666;border:none;resize: none;width:90%;height:120px;margin: 10px auto;" readonly="true">我在推推网玩了很多天了，每天收入不算多，四五十元，就当赚点零花钱。提现速度快，几分钟内就能到账。推荐想赚小钱的朋友进来玩玩：<?php echo $domain; ?>home/auth/register.html?i=<?php echo $member['uid']; ?></textarea>
                    </div>
                    <div class="clipboards" style="width:96%;display:block;margin: 0 auto;overflow: hidden;text-align: center;">
                        <a href="javascript:" id="copybtn" class="button5" onclick="copy(this)" data-copy="我在推推网玩了很多天了，每天收入不算多，四五十元，就当赚点零花钱。提现速度快，几分钟内就能到账。推荐想赚小钱的朋友进来玩玩：<?php echo $domain; ?>home/auth/register.html?i=<?php echo $member['uid']; ?>">复制内容</a>
                    </div>
    ...
    <ul>
        ...
        <script>
            window._bd_share_config = {
                common : {
                    bdText : '我在推推网玩了很多天了，每天收入不算多，四五十元，就当赚点零花钱。提现速度快，几分钟内就能到账。推荐想赚小钱的朋友进来玩玩：<?php echo $domain; ?>home/auth/register.html?i=<?php echo $member['uid']; ?>', 
                    bdDesc : '我在推推网玩了很多天了，每天收入不算多，四五十元，就当赚点零花钱。提现速度快，几分钟内就能到账。推荐想赚小钱的朋友进来玩玩：<?php echo $domain; ?>home/auth/register.html?i=<?php echo $member['uid']; ?>', 
