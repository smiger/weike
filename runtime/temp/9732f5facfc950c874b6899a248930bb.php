<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"./views/home/mobile/invite\index.phtml";i:1578384742;s:71:"D:\BaiduYunDownload\weike2\public\views\home\mobile\common\footer.phtml";i:1578387613;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
    ...
    <head>
        ...
        <title>互助-微信投票,微信助力,APP下载,游戏推广……可以拉票推广点赞关注</title>
            ...
            <div class="add-box">
                <div class="add-cont">
                    <div class="sns_box">
                        ...
                        <div class="myMoney">
                            <p>累计邀请返利</p>
                            <p><span class="money"><?php echo $money; ?></span>积分</p>
                        </div>
                    </div>
                    <div class="bk10">
                    </div>
                    <div class="sns_box">
                        <textarea id="sharetext" class="text_box" style="color:#666;border:none;resize: none;width:90%;height:120px;margin: 10px auto;" readonly="true">我在互助网玩了很多天了，做任务赚积分，积分可以发布砍价、关注、点赞等任务。加入我们一起互帮互助吧：<?php echo $domain; ?>home/auth/register.html?i=<?php echo $member['uid']; ?></textarea>
                    </div>
                    <div class="clipboards" style="width:96%;display:block;margin: 0 auto;overflow: hidden;text-align: center;">
                        <a href="javascript:" id="copybtn" class="button5" onclick="copy(this)" data-copy="我在互助网玩了很多天了，做任务赚积分，积分可以发布砍价、关注、点赞等任务。加入我们一起互帮互助吧：<?php echo $domain; ?>home/auth/register.html?i=<?php echo $member['uid']; ?>">复制内容</a>
                    </div>
                    ...
                    <!--<div class="pro-info" style="height: 80px;width: 90%;margin: 20px auto;display: block;">
                        <p style="padding:5px; font-size: 16px;color: #272727;font-family: 'Microsoft YaHei UI', 'Microsoft YaHei', SimSun, 'Segoe UI', Tahoma, Helvetica, Sans-Serif;">邀请徒弟加入互助，徒弟需绑定好邮箱与支付宝，徒弟每完成一个任务得到雇主通过，师父即可获得徒弟完成任务佣金的【25%奖励】</p>
                    </div>-->
                </div>
    ...
    <ul>
        ...
        <script>
            window._bd_share_config = {
                common : {
                    bdText : '我在互助网玩了很多天了，做任务赚积分，积分可以发布砍价、关注、点赞等任务。加入我们一起互帮互助吧：<?php echo $domain; ?>home/auth/register.html?i=<?php echo $member['uid']; ?>',
                    bdDesc : '我在互助网玩了很多天了，做任务赚积分，积分可以发布砍价、关注、点赞等任务。加入我们一起互帮互助吧：<?php echo $domain; ?>home/auth/register.html?i=<?php echo $member['uid']; ?>',
