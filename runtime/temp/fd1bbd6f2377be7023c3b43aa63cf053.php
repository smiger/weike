<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"./views/home/mobile/task\add.phtml";i:1578379714;s:71:"D:\BaiduYunDownload\weike2\public\views\home\mobile\common\footer.phtml";i:1578387613;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
            ...
            <form id="post_form">
                <div class="task">
                    ...
                    <div class="task-item">任务金额：
                        <input type="text" id="count_money" name="give_credit2" class="task-txt" readonly="readonly" placeholder="总积分" value="<?php echo !empty($item['give_credit2'])?$item['give_credit2']:''; ?>" />
                        <span class="ts1">余额 <span id="now_gold"><?php echo $member['credit2']; ?></span>积分</span>
                    </div>
...
<!--                            <?php if(check_array($setting['period'])): ?>-->
<!--                                <?php if(is_array($setting['period']) || $setting['period'] instanceof \think\Collection || $setting['period'] instanceof \think\Paginator): $i = 0; $__LIST__ = $setting['period'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$period): $mod = ($i % 2 );++$i;?>-->
...
<!--                    </div>-->
        ...
        <script type="text/javascript" src="/static/home/mobile/js/task_add.js?v=12"></script>
