<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:38:"./views/home/mobile/auth\findpwd.phtml";i:1541935408;}*/ ?>
<html>
<head>
        ...
        <div class="denglu-box">
            <div class="dl-form">
                ...
                <div class="item-box">
                    ...
                    <div class="yzm">
                        <img id="forgetpass-verifycodeimg" style="width:90px; height:30px;"  src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random()" alt="captcha" />
                    </div>
                </div>
                </form>
            </div>
...
$(function () {
    ...
    function verifycodeimg(prefix){
        ...
        $('#' + prefix + '-verifycodeimg').attr("src", '<?php echo captcha_src(); ?>?' + timenow);
    }
