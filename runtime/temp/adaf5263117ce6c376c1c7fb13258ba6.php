<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"./views/home/mobile/account\index.phtml";i:1578386125;s:71:"D:\BaiduYunDownload\weike2\public\views\home\mobile\common\footer.phtml";i:1578387613;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
	<head>
		...
		<link href="/static/home/mobile/css/new_style.css?v=1001" rel="stylesheet" type="text/css" />
        <!-- 弹出层 -->
        ...
        <script type="text/javascript" src="/static/home/mobile/js/global.js?v=1003"></script>
	</head>
	<style type="text/css">
		...
		<div class="main accountCenter">
			...
			<div class="jifen cl">
				<div class="jf_one">
					...
					<div class="jf_desc">余额<span id="gold"><?php echo !empty($member['credit2'])?$member['credit2']:0; ?></span>积分
						<ul>
<!--							<li onclick="location.href='/home/recharge.html'">充值</li>-->
<!--							<li onclick="location.href='/home/account/withdraw.html'">取现</li>-->
							<li onclick="location.href='/home/charge.html'">积分记录</li>
						</ul>
					</div>
				</div>
...
<!--						</li>-->
			...
			<div class="jifen cl qqclipboards">
				<div class="jf_one">
					<i class="jf_ico"><img src="/static/home/mobile/picture/qq1.png"/></i>
					<div class="jf_desc">
						QQ群
					</div>
					 <span style="cursor: pointer" class="more-btn" data-copy="<?php echo !empty($site['qq'])?$site['qq']:''; ?>" onclick="copyqq(this)"><?php echo !empty($site['qq'])?$site['qq']:''; ?></span>
				</div>
			</div>
