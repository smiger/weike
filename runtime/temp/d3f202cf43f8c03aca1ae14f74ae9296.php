<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:38:"./views/home/mobile/signin\index.phtml";i:1578038127;}*/ ?>
<!DOCTYPE html>
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
			...
			<div class="out-1 flex flex-align-center flex-pack-center" id="signIn">
				<div class="out-2 flex flex-align-center flex-pack-center">
					<div class="signBtn">
						...
						<span>连续<em id="sign-count"><?php echo $member['sign_continue']; ?></em>天</span>
					</div>
				</div>
			</div>
		</div>
		...
		<script language="JavaScript">
			var isSign = <?php echo !empty($is_sign)?'true':'false'; ?>;
			var myday = <?php echo $myday; ?>; //已签到的数组
